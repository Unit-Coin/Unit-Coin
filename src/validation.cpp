...
#if defined(NDEBUG)
# error "Unit cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Unit Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s UT additional fees, %d delta bytes\n",
