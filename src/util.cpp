...
const char * const BITCOIN_CONF_FILENAME = "unit.conf";
const char * const BITCOIN_PID_FILENAME = "unitd.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Unit";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Unit";
#else
    // Unix
    return pathRet / ".unit";
#endif
