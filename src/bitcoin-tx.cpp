...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s unit-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  unit-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded unit transaction") + "\n" +
              "  unit-tx [options] -create [commands]   " + _("Create hex-encoded unit transaction") + "\n" +
              "\n";
