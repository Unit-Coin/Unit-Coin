...
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 22097
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 22098
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 32097
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 32098
...
if [ $1 -eq 0 ]; then
	if [ `%{_sbindir}/sestatus |grep -c "disabled"` -eq 0 ]; then
	%{_sbindir}/semanage port -d -p tcp 22097
	%{_sbindir}/semanage port -d -p tcp 22098
	%{_sbindir}/semanage port -d -p tcp 32097
	%{_sbindir}/semanage port -d -p tcp 32098
